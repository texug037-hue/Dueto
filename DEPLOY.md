...
- Login exclusivo por número e senha (só os 2 números cadastrados entram;
  qualquer outro é bloqueado também no `onAuthStateChanged`).
...
- Uploads de comprovante limitados a aproximadamente 600KB e só imagem/PDF,
  pois são guardados diretamente no Firestore.
