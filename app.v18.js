...
function startListening(){
  ...
  const qNotif = query(collection(db, 'notificacoes'), orderBy('quando', 'desc'));
  ...
  }, (err) => console.error('Notificações:', err));
}
...
async function notificar(titulo, corpo){
  ...
  try {
    await addDoc(collection(db, 'notificacoes'), {
      titulo, corpo, quando: serverTimestamp(), criadoPor: currentUser.uid, ocultasPor: []
    });
