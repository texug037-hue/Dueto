...
window.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('btnAdicionarBiometria').addEventListener('click', cadastrarBiometriaPelaTelaInicial);
  ...
  try {
    ...
    const cred = await navigator.credentials.create({
      publicKey: {
        ...
        rp: { name: 'Dueto', id: location.hostname },
        user: {
...
async function entrarComBiometria(){
  ...
  try {
    ...
    if (!saved || !NUMEROS_AUTORIZADOS[saved.phone] || !saved.senha) {
      loginSolicitado = false;
      err.textContent = 'Digital confirmada. Digite o número e a senha uma vez para vincular este aparelho.';
      return;
    }
