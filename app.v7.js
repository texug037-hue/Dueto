...
function cardHtml(c){
  ...
  const amtRow = c.pago ? '' :
    `<div class="amt-row"><span class="amt-prefix">R$</span><input type="number" step="0.01" class="amt-input"><button class="amt-cancel" data-id="${c.id}">Cancelar</button><button class="amt-confirm" data-id="${c.id}">Confirmar</button></div>`;
